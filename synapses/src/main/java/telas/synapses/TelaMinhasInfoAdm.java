...
public class TelaMinhasInfoAdm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 140, 40));
        ...
        jPanel1.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, -1, -1));

        txtNome.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        txtNome.setText("jLabel5");
        jPanel1.add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 80, -1, -1));

        txtId.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        txtId.setText("jLabel4");
        jPanel1.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 40, -1, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 150, 310, 200));
